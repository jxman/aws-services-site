                ...
                <div className="px-6 py-4 space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-bg-tertiary rounded-lg p-4">
                      <div className="text-sm text-text-secondary mb-1">Regional Availability</div>
                    ...
                    <div className="bg-bg-tertiary rounded-lg p-4">
                      <div className="text-sm text-text-secondary mb-1">Coverage</div>
                  ...
                  {/* Coverage Bar */}
                  <div className="bg-bg-tertiary rounded-lg p-4">
                    <div className="text-sm text-text-secondary mb-2">Regional Distribution</div>
