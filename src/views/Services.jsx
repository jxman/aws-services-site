...
function Services() {
  ...
  return (
    <Container>
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-text-light-primary dark:text-text-primary mb-2">AWS Services</h1>
      ...
      {filteredAndSortedServices.length === 0 ? (
        <div className="text-center py-16 bg-bg-light-secondary dark:bg-bg-secondary rounded-lg border border-border-light dark:border-border">
          ...
          <p className="text-text-light-secondary dark:text-text-secondary text-lg">No services match your search criteria</p>
          <button
            onClick={() => {
              setSearchTerm('');
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  ...
                  <p className="text-sm text-text-light-secondary dark:text-text-secondary font-mono">{service.code}</p>
                </div>
                <div
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-text-light-secondary dark:text-text-secondary">Available In:</span>
